<template>
  <el-dialog
    ...
    <el-form-item label="[0->PC1->app]" prop="sourceType">
      <el-input v-model="dataForm.sourceType" placeholder="[0->PC1->app]"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          sourceType: [
            { required: true, message: '[0->PC1->app]不能为空', trigger: 'blur' }
          ],
          status: [
