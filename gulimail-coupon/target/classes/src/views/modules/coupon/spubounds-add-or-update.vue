<template>
  <el-dialog
    ...
    <el-form-item label="[1111;0 - ;1 - ;2 - ;3 - 01]" prop="work">
      <el-input v-model="dataForm.work" placeholder="[1111;0 - ;1 - ;2 - ;3 - 01]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          work: [
            { required: true, message: '[1111;0 - ;1 - ;2 - ;3 - 01]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
