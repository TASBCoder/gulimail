<template>
  <el-dialog
    ...
    <el-form-item label="[1-web2-app]" prop="loginType">
      <el-input v-model="dataForm.loginType" placeholder="[1-web2-app]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          loginType: [
            { required: true, message: '[1-web2-app]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
